...
class MaintainabilityAuditTests(unittest.TestCase):
    ...
    def test_generated_workflow_integrates_audit_without_silent_scope_expansion(self) -> None:
        ...
        self.assertIn("audit the scoped area before artifact choice", spec_skill)
        self.assertIn("implemented diff at closeout", spec_skill)
        ...
        self.assertIn("Never expand approved scope silently", normalized_guide)
